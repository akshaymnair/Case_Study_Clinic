...
import javax.servlet.http.*;  
    ...
    public class doc_up extends HttpServlet {  
  ...
  if(acnt.equals("No")){
    ...
    ps=con.prepareStatement("UPDATE doctor SET lname=?,mail=?,phone=?,password=?,exp=?,qual=? WHERE user=? ");     
  ...
  else if(acnt.equals("Yes"))
  {
    ...
    con=DriverManager.getConnection(  
     ...
     ps=con.prepareStatement("DELETE FROM doctor WHERE user=?");  
