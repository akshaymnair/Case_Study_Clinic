...
<div id="topline">	
	<div class="content">
       <a><strong>Welcome !!</strong> Dr. <%=name %> </a>
    </div>
</div><!-- topline -->
    	...
    	<div class="content">
             ...
             <div id="header">
                     <div id="menu">
                        ...
                        <br></br>
                        <br></br>
                        	<li class="selected"><a href="d-mail.jsp"><font color=white>Mail</font></a></li>
                            <li class="selected"><a href="mypat.jsp"><font color=white>Patients</font></a></li>
                            ...
                            <li class="selected"><a href="d-profile.jsp"><font color=white>Profile</font></a></li>
