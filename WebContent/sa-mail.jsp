...
<body>
<FORM name="mail" ACTION = "ssmail" onsubmit="return validateForm()" method="post">
...
SELECT user from supplier;                          
</sql:query>
<pre>
<h3><font color=khaki><b>
&nbsp;&nbsp;&nbsp; Select your Supplier	:<select name="receiv">
...
<sql:query dataSource="${snapshot}" var="result">
SELECT sender,msg,date from ssmail where receiver=? ORDER BY date DESC
 <sql:param value="${use}" />
...
SELECT receiver,msg,date from ssmail where sender=? ORDER BY date DESC
 <sql:param value="${use}" />
