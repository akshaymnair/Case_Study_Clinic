...
%>
<c:set var="use" value='<%=name%>'></c:set>
<div id="topline">	
	<div class="content">
...
SELECT user from doctor;                          
</sql:query>
<pre>
<h3><font color=khaki><b>
&nbsp;&nbsp;&nbsp; Select your Doctor	:<select name="receiv">
...
<c:forEach var="row" items="${result.rows}">
<tr>
<td><font color=DarkSlateGray>Dr.<c:out value="${row.sender}"/></font></td>
...
<tr>
<td><font color=DarkSlateGray>Dr. <c:out value="${row1.Receiver}"/></font></td>
